...
\yearblock[To be presented]{(Poster presentation) \textit{Towards a history of the tenseness contrast in Brythonic vowels}. The Third Edinburgh Symposium on Historical Phonology, University of Edinburgh, Edinburgh, UK.}
\yearblock{\textit{Pre-sonorant voicing and language contact}. The Third Edinburgh Symposium on Historical Phonology: Laryngeal Fringe Session, University of Edinburgh, Edinburgh, UK.}
\yearblock[2017]{\textit{Bridging the gap: Tenseness and length in Brythonic vowels}. New Approaches to Brythonic Historical Linguistics, Dublin Institute for Advanced Studies, Dublin, Republic of Ireland.}
...
\begin{multicols}{2}
\yearblock[The University of Edinburgh]{Univariate Statistics Using R (MSc)}
