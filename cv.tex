...
\yearblock[The University of Edinburgh]{Phonological Theory (Honours)}
...
\yearblock[University of Ulster]{CMM728 Theoretical Approaches to the Phonetics and Phonology of English (MSc)}
\yearblock{CMM302 Linguistics for Clinicians 2 (2nd year BSc)}
\yearblock{CMM151 Linguistic Analysis (1st year BSc)}
\yearblock{CMM351 Linguistic Theory (2nd year BSc)}
\yearblock{CMM317 Research Methods (2nd year BSc)}
\yearblock{CMM521 Current Issues in Linguistic Theory (3rd year BSc)}
\yearblock{CMM727 Critical Review (MSc)}
\yearblock[University of Tromsø]{LIN-1014 Historical Linguistics (BA)}
\yearblock{EXF-0720, EXF-0723 \textit{Examen  facultatum} for the humanities (1st year BA)}
\yearblock{RUS-2040 Structures of  Russian (2nd year BA)}
\yearblock{RUS-3010 Language and  Literature of Medieval Russia (MA)}
\yearblock{\LaTeX{} for Linguists}
\yearblock{LIN-1030 Phonetics (BA)}
...
\block{Programming}{Common Lisp, Python (fair knowledge); R, Haskell, JavaScript (some knowledge); C, SQL, Ruby (basic knowledge)}
...
Book manuscripts: Cambridge University Press\\
