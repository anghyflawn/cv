...
\titleformat{\section}{\Large\fontspec[Weight=Bold]{Arimo}\raggedright}{}{0em}{}[\titlerule]
\titleformat{\subsection}{\large\fontspec{Arimo}\raggedright}{}{0em}{}
...
\textitrussian{Вакашские языки} (Wakashan languages), \textitrussian{Ирландский язык} (Irish [Gaelic]), \textitrussian{Идома} (Idoma), \textitrussian{Йоруба} (Yoruba), \textitrussian{Иджоидные языки} (Ijoid languages), \textitrussian{Ирокезские языки} (Iroquois languages), \textitrussian{Кельтские языки} (Celtic languages), \textitrussian{Корнский язык} (Cornish)}
...
\yearblock{\textit{There is no problem of /v/ in Russian phonology.} 26th Manchester Phonology Meeting, University of Manchester, Manchester, UK.}
\yearblock[2018]{\textit{Norwegian preaspiration in traditional and modern sources.} 13th Forum for Germanic Language Studies, University of Edinburgh, Edinburgh, UK.}
