...
\yearblock[Forthcoming]{Prosodic structure and suprasegmental features: Short-vowel stød in Danish. Accepted to \emph{Journal of Comparative Germanic Linguistics}.}
\yearblock{Welsh svarabhakti as stem allomorphy. Accepted to \emph{Transactions of the Philological Society}.}
...
\yearblock[To be presented]{(with Máire Ní Chiosáin) \textit{Making sense of consonant palatalization and vowel backness in Irish}. Language Documentation and Linguistic Theory 5, School of Oriental and African Studies, London, UK.}
...
\yearblock{(with Will Lamb) \textit{Morphology and dialectology: A quantitative approach}. Rannsachadh na Gàidhlig 2016, Sabhal Mòr Ostaig, Sleat, Scotland.}
\yearblock[2016]{(with Remco Knooihuizen) \textit{Vowel length in Shetland Norn: Contact, change, and competing systems}. AMC Symposium on Historical Dialectology, The University of Edinburgh, Edinburgh, Scotland.}
