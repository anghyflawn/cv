...
PhD project supervisor: \href{http://www.hum.uit.no/a/moren}{Dr Bruce Morén-Duolljá}\\
Project title: \emph{Representation and variation in substance-free phonology: a case study in Celtic} (submitted August 3rd, 2012)\\
...
\yearblock[2006]{Grant under the `Talented Youth Supports' programme,  National project `Education' (Education and Science Ministry of Russia)}
...
\yearblock[Spring 2010]{LIN-1014 Historical Linguistics (introductory Bachelor course); with Violeta Martínez-Paricio}
...
\yearblock[Spring 2008]{LIN-1030 Phonetics (introductory Bachelor course); with Dragana Šurkalović}
